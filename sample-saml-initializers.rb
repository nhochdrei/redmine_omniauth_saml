Redmine::OmniAuthSAML::Base.configure do |config|
  config.saml = {
    ...
    :idp_sso_service_url            => "http://sso.desarrollo.unlp.edu.ar/saml2/idp/SSOService.php", # SSO login endpoint
    ...
    :idp_slo_service_url            => "http://sso.example.com/saml2/idp/SingleLogoutService.php",
